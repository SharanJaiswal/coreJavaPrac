...
//    public static boolean isCompatibleBest(E animal1, E animal2) {
    public static <E extends Animals> boolean isCompatibleBest(E animal1, E animal2) {  // Type inside <> must be between "static" keyword and return type.
...
//        says that E cannot be referenced from the generic type
...
//        Therefore, in the method signature, there is error on "E" in argument parenthesis.
        /**
         * Also, here "E" inside the parenthesis of method signature, "E" is not same as the "E" which is mentioned inside <> of class signature. This method's "E" will not get replaced
         * when instance of this class gets created providing "Type" inside <>. We could think that this method's "E" will get replaced when calling the method using class name,
         * by providing "Type" inside <> at static invocation, ie, BestCage<Monkey, Monkey>.isCompatibleBest(m1, m2); ; but type of "E" will still not get resolved.
