...
//        obj.stat1();    // cannot refer static method of interface using object reference at all because it is not inherited, because class can only be inherited not interfaces
        ...
        A.stat1();
//        B.stat1();    // Even B also cannot call static method of A even though B implements A. Reason is, B doesn't extend A as if A is calls. A is not class but interface.
