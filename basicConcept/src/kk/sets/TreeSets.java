 ...
 * add(), remove(), contains(), all 3 happens at O(log N) time. Because, add() nad remove() first checks if element is present or not (contains), and then perform node deletion|addition.
