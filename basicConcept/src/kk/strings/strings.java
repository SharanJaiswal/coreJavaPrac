...
//        System.out.println(null);   // this will give error because println could not able to decide whether the null is of type String or char[] or any data type that can have null.
        ...
        Operator '+' is defined in java when operands are primitives
        and overloaded when at least one of the operand is String type among first 2 operands.
        ...
        or, all the operands are combinations of characters and integers. Strictly, it follows the combined rules of operator precedence order of execution and
        fact that one of the operand should've of type String if all the operands for a given '+' operator is not of primitive type.
         */
...
//        System.out.println(5 + new int[] {1,2,3,4,5});    // Error even if operands are interchanged
        ...
        // While Arrays is derive data type, with toString method overridden into Arrays class.
