...
public interface A {
    ...
    /*
    In real world, once interface gets published, its out there to use and implement, and override methods.
    We cannot simply add one more abstract method in the interface which is being implemented by many.
    If we do so, in that it will require every numerous implementation of it to override newly added abstract method.
    ...
    functionality of that interface method, required developer to change its overridden body in all the classes
